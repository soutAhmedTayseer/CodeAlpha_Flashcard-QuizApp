...
class _TestScreenState extends State<TestScreen> with TickerProviderStateMixin {
  ...
  final Map<int, String> _userAnswers = {}; // Store answers for each question
  final TextEditingController _answerController = TextEditingController(); // Controller for text field
  int _quizNumber = 1;
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Quiz $_quizNumber',
                              style: const TextStyle(fontSize: 16, color: Colors.orange), // Dark orange text color
                            ),
                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: Center(
                            child: Text(
                              question,
                              style: const TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Colors.orange), // Dark orange text color
                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            style: const TextStyle(color: Colors.white), // Dark orange input text color
                          ),
                        ),
                      ),
                    ],
